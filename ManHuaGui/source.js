...
},{"./APIWrapper":1,"./base":5,"./models":48}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Button":10,"./Form":12,"./FormRow":11,"./Header":13,"./InputField":14,"./Label":15,"./Link":16,"./MultilineLabel":17,"./NavigationButton":18,"./OAuthButton":19,"./Section":20,"./Select":21,"./Stepper":22,"./Switch":23,"./WebViewButton":24}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Chapter":8,"./ChapterDetails":7,"./Constants":9,"./DynamicUI":25,"./HomeSection":26,"./Languages":27,"./Manga":30,"./MangaTile":28,"./MangaUpdate":29,"./PagedResults":31,"./RawData":32,"./RequestHeaders":33,"./RequestInterceptor":34,"./RequestManager":35,"./RequestObject":36,"./ResponseObject":37,"./SearchField":38,"./SearchRequest":39,"./SourceInfo":40,"./SourceManga":41,"./SourceStateManager":42,"./SourceTag":43,"./TagSection":44,"./TrackedManga":46,"./TrackedMangaChapterReadAction":45,"./TrackerActionQueue":47}],49:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
class ManHuaGui extends paperback_extensions_common_1.Source {
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const request = createRequestObject({
                url: `${MHG_DOMAIN}/s/${encodeURI((_b = query.title) !== null && _b !== void 0 ? _b : '')}_p${page}.html`,
    ...
    getHomePageSections(sectionCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(response.data);
            ManHuaGuiParser_1.parseHomeSections($, sectionCallback);
        });
    }
}
exports.ManHuaGui = ManHuaGui;

},{"./ManHuaGuiParser":50,"paperback-extensions-common":6}],50:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
exports.parseHomeSections = exports.isLastPage = exports.parseSearch = exports.parseChapterDetails = exports.parseChapters = exports.parseMangaDetails = void 0;
/* eslint-disable linebreak-style */
/* eslint-disable @typescript-eslint/no-unused-vars */
...
const parseMangaDetails = ($, mangaId) => {
    ...
    const author = $('span:contains(漫画作者) > a , span:contains(漫畫作者) > a')
        .text()
        .trim()
        .replace(' ', ', ');
    const statusString = $('div.book-detail > ul.detail-list > li.status > span > span')
        .first()
        .text();
    ...
    // second element
    const lastUpdatedString = $('div.book-detail > ul.detail-list > li.status > span > span')
        .last()
        .text();
    const lastUpdated = moment_1.default(lastUpdatedString, 'YYYY-MM-DD').toDate();
    return createManga({
        id: mangaId,
        titles: titles,
        image: image,
...
const parseChapterDetails = (_$, mangaId, chapterId, rawResponse) => {
    var _a;
    ...
    const evalString = (_a = evalMatch[1]) !== null && _a !== void 0 ? _a : '';
...
const parseSearch = ($) => {
    ...
    for (const manga of $('div.book-result > ul > li').toArray()) {
        const link = (_a = $('a.bcover', manga).attr('href')) !== null && _a !== void 0 ? _a : '';
        const id = (_b = link.split('/')[2]) !== null && _b !== void 0 ? _b : '';
        const title = (_c = $('a.bcover', manga).attr('title')) !== null && _c !== void 0 ? _c : '';
...
const isLastPage = ($) => {
    ...
    for (const pageTurnButton of pageTurnButtons) {
        ...
        const text = (_a = $el.text()) !== null && _a !== void 0 ? _a : '';
...
const parseHomeSections = ($, sectionCallback) => {
    ...
    for (const section of sections) {
        ...
        for (const manga of $('li', section.selector).toArray()) {
            const url = (_a = $('a.bcover', manga).attr('href')) !== null && _a !== void 0 ? _a : '';
            const id = (_b = url.split('/')[2]) !== null && _b !== void 0 ? _b : '';
            const title = (_c = $('a.bcover', manga).attr('title')) !== null && _c !== void 0 ? _c : '';
            // image could be on src or data-src
            const image = `https:${(_d = $('a.bcover > img', manga).attr('src')) !== null && _d !== void 0 ? _d : $('a.bcover > img', manga).attr('data-src')}`;
...
},{"moment":2,"paperback-extensions-common":6}]},{},[49])(49)
});
